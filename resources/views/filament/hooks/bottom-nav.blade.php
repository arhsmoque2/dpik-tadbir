...
>
    <div
        ...
        style="height: 60px; min-width: 320px; max-width: 420px; background: rgba(24, 25, 30, 0.92); border-color: rgba(255, 255, 255, 0.15); box-shadow: 0 16px 32px rgba(0, 0, 0, 0.5);"
    >
        <!-- Slot 1: Dashboard -->
        <a
            href="/admin"
            class="flex flex-col items-center justify-center flex-1 text-xs text-zinc-200 hover:text-white transition-colors"
            title="Dashboard"
        >
            ...
            <span class="text-[10px] mt-0.5 tracking-tight font-medium">Home</span>
        </a>
        ...
        >
            ...
            <span class="text-[10px] mt-0.5 tracking-tight font-medium">Tugas</span>
        </a>
        ...
        >
            ...
            <span class="text-[10px] mt-0.5 tracking-tight font-medium">Memory</span>
        </a>
        ...
        >
            ...
            <span class="text-[10px] mt-0.5 tracking-tight font-medium">Settings</span>
        </a>
    </div>
</div>
@endauth
