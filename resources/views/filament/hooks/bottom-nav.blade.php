...
>
    <div
        ...
        style="height: 60px; min-width: 320px; max-width: 420px; background: rgba(24, 25, 30, 0.96); border-color: rgba(255, 255, 255, 0.2); box-shadow: 0 16px 32px rgba(0, 0, 0, 0.5); color: #FFFFFF;"
    >
        <!-- Slot 1: Dashboard -->
        <a
            href="/admin"
            ...
            title="Dashboard"
        >
            <svg style="width: 20px; height: 20px; min-width: 20px; color: #FFFFFF;" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <span style="color: #FFFFFF; font-size: 10px; line-height: 12px; margin-top: 2px; font-weight: 600;">Home</span>
        </a>
        ...
        >
            ...
            <span style="color: #FFFFFF; font-size: 10px; line-height: 12px; margin-top: 2px; font-weight: 600;">Tugas</span>
        </a>
        ...
        >
            ...
            <span style="color: #FFFFFF; font-size: 10px; line-height: 12px; margin-top: 2px; font-weight: 600;">Memory</span>
        </a>
        ...
        >
            ...
            <span style="color: #FFFFFF; font-size: 10px; line-height: 12px; margin-top: 2px; font-weight: 600;">Settings</span>
        </a>
    </div>
</div>
@endauth
